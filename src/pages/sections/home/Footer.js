...
function Footer() {
  return (
    <React.Fragment>
		...
		{/* Slick nav JS */}
		<script type="text/babel" src="../../../assets/js/jquery.slicknav.min.js"></script>
		{/* owl carousel JS */}
		<script type="text/babel" src="../../../assets/js/owl.carousel.min.js"></script>
		{/* Popup JS */}
		<script type="text/babel" src="../../../assets/js/jquery.magnific-popup.min.js"></script>
		{/* Isotope JS */}
		<script type="text/babel" src="../../../assets/js/isotope.pkgd.min.js"></script>
		{/* main JS */}
